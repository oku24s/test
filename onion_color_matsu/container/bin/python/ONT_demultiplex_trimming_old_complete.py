...
for rec in recs:
    ...
    if Levenshtein.distance(str(index), index1_F) < 1:
        rec1_F.append(rec.id)

    elif Levenshtein.distance(str(index), index2_F) < 1:
        rec2_F.append(rec.id)

    elif Levenshtein.distance(str(index), index3_F) < 1:
        rec3_F.append(rec.id)

    elif Levenshtein.distance(str(index), index4_F) < 1:
        rec4_F.append(rec.id)

    elif Levenshtein.distance(str(index), index5_F) < 1:
        rec5_F.append(rec.id)

    elif Levenshtein.distance(str(index), index6_F) < 1:
        rec6_F.append(rec.id)

    elif Levenshtein.distance(str(index), index7_F) < 1:
        rec7_F.append(rec.id)

    elif Levenshtein.distance(str(index), index8_F) < 1:
        rec8_F.append(rec.id)

    elif Levenshtein.distance(str(index), index9_F) < 1:
        rec9_F.append(rec.id)

    elif Levenshtein.distance(str(index), index10_F) < 1:
        rec10_F.append(rec.id)

    elif Levenshtein.distance(str(index), index11_F) < 1:
        rec11_F.append(rec.id)

    elif Levenshtein.distance(str(index), index12_F) < 1:
        rec12_F.append(rec.id)

    elif Levenshtein.distance(str(index), index13_F) < 1:
        rec13_F.append(rec.id)

    elif Levenshtein.distance(str(index), index14_F) < 1:
        rec14_F.append(rec.id)

    elif Levenshtein.distance(str(index), index15_F) < 1:
        rec15_F.append(rec.id)

    elif Levenshtein.distance(str(index), index16_F) < 1:
...
for rec in recs:
    ...
    index16_R = "CTAGAGAT"
     ...
     #indexを12個に振り分ける
    if Levenshtein.distance(str(index), index1_R) < 1:
        rec1_R.append(rec.id)

    elif Levenshtein.distance(str(index), index2_R) < 1:
        rec2_R.append(rec.id)

    elif Levenshtein.distance(str(index), index3_R) < 1:
        rec3_R.append(rec.id)

    elif Levenshtein.distance(str(index), index4_R) < 1:
        rec4_R.append(rec.id)

    elif Levenshtein.distance(str(index), index5_R) < 1:
        rec5_R.append(rec.id)

    elif Levenshtein.distance(str(index), index6_R) < 1:
        rec6_R.append(rec.id)

    elif Levenshtein.distance(str(index), index7_R) < 1:
        rec7_R.append(rec.id)

    elif Levenshtein.distance(str(index), index8_R) < 1:
        rec8_R.append(rec.id)

    elif Levenshtein.distance(str(index), index9_R) < 1:
        rec9_R.append(rec.id)

    elif Levenshtein.distance(str(index), index10_R) < 1:
        rec10_R.append(rec.id)

    elif Levenshtein.distance(str(index), index11_R) < 1:
        rec11_R.append(rec.id)

    elif Levenshtein.distance(str(index), index12_R) < 1:
        rec12_R.append(rec.id)

    elif Levenshtein.distance(str(index), index13_R) < 1:
        rec13_R.append(rec.id)

    elif Levenshtein.distance(str(index), index14_R) < 1:
        rec14_R.append(rec.id)

    elif Levenshtein.distance(str(index), index15_R) < 1:
        rec15_R.append(rec.id)

    elif Levenshtein.distance(str(index), index16_R) < 1:
